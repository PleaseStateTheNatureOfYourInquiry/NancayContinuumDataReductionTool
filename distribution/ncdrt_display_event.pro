...
;----------Apply the cut and the linear correction and show it-----------------
        ...
        If (sky_subtract_tool_active EQ 1) AND (sky_file_base NE '') AND $
           (main_slider_track EQ 1) Then Begin
...
;----------Launch the sky subtraction tool-------------------------------------

       If uval EQ 'SKYSUBTRACTTOOL' Then Begin

        If sky_subtract_tool_active EQ 1 Then Goto,r550

        If n_scan_processed GT 0 Then Begin

         SKY_SUBTRACT_DISPLAY
