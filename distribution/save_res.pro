...
;----------Start SAVE_OBS------------------------------------------------------
       ...
       If sky_subtract_apply EQ 1 Then Begin
        ...
        Printf , file_unit , ' Subtracted : ' , $
         sky_data_path + sky_scan_number + '_f*.fits'
        Printf , file_unit , $
         Format = $
         '(" Sky offset cutting + shift (IDL coordinates) ",3(2x,I3))' , $
         sky_t_offset_low , sky_t_offset_high , sky_shift

       Endif Else Begin

        Printf , file_unit , ' Subtracted : nothing subtracted'
        Printf , file_unit , ' ' 
