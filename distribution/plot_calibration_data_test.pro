...
;----------Channels 1 and 2 + 1+3 and 2+4 general plot-------------------------
       ...
       For i = 0,1 Do Begin
        ...
        PLOT_CALIBRATION_DATA_ALL_2CHANNELS , i
...
;----------Channels 1 and 2 + 1+3 and 2+4 detailed plot------------------------
       ...
       For i = 0,1 Do Begin
        ...
        PLOT_CALIBRATION_DATA_DETAIL_2CHANNELS , i
...
;----------Channels 6 + 1to8 general plot--------------------------------------


       !p.region = plot_region(6+6,*)
       PLOT_CALIBRATION_DATA_ALL_2CHANNELS , 6
...
;----------Channels 6 + 1to8 detailed plot-------------------------------------


       !p.region = plot_region(6+8,*)
       PLOT_CALIBRATION_DATA_DETAIL_2CHANNELS , 6
...
;----------Channels 8 detailed plot--------------------------------------------
       ...
       If count_j GT 0 Then Begin
        ...
        Plot,calibration_time(j)-calibration_time(0),$
         calibration_factors(j,i),$
         xrange=[time_low_det,time_high_det],xs=1,yrange=[0.7,1.3],ys=1,$
...
;----------date: 26 - 07 - 2004------------------------------------------------
      ...
      PRO PLOT_CALIBRATION_DATA_ALL_2CHANNELS , i
...
;----------date: 26 - 07 - 2004------------------------------------------------
      ...
      PRO PLOT_CALIBRATION_DATA_DETAIL_2CHANNELS , i
...
;----------(i.e. its value is -1.0)-------------------------------------------
       ...
       If count_k GT 0 Then Begin
        ...
        y = FLTARR(count_k)
        y(*) = 0.75
        Oplot,calibration_time(k)-calibration_time(0),y,psym=5
