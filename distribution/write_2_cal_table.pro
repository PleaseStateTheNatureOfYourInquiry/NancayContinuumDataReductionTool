...
;----------MAP 95 and MAP 96 of UIC 143----------------------------------------

       If central_freq EQ 2065 Then Begin
...
;----------MAP 3 and 5 and MAP 4 and 6 of UIC 213------------------------------
       ...
       If STRCOMPRESS(object) EQ calibrator Then Begin
...
;----------Linear interpolation between 1413 and 2690 MHz values---------------

        If central_freq EQ 2065 Then Begin

         cal_central_freq = 8.67
         cal_central_freq_low = 8.67
         cal_central_freq_up = 8.67
