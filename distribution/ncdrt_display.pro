...
;----------Create the base of NCDRT--------------------------------------------
       ...
       base = Widget_base(title='Nancay CDR Tool (V2.1)'$
                          , column=2)
...
;----------Sky subtract tool button--------------------------------------------

       sky_subtract_tool = Widget_button(base , $
        value='NCDRT Sky Subtract Tool' , uvalue = 'SKYSUBTRACTTOOL')
...
;---------Initial setting for the tracking switch in the sky subtraction tool--
...
;----------Initialisation of the sky subtraction parameters--------------------
