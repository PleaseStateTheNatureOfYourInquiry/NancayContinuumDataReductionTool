...
;----------08-10-2005----------------------------------------------------------
;----------Added this line in order to avoid the problem on the different------
;----------format in POU files from the MAP 95.143 and 96.143------------------

       If central_freq EQ 0 Then central_freq = 2065.0
...
;----------Reset the sky subtract apply switch and the sky offset cuttings-----

       sky_subtract_apply = 0
       sky_t_offset_low_res = 0
       sky_t_offset_high_res = 0
